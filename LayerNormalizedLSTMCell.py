# 这里是在tensorflow.nn.rnn_cell.LSTMCell()的基础上加入了Layer Normalization。
# ln()输入tensor输出layer normalized之后的tensor。
# layer normalization运算在i(input_gate),f(forget_gate),o(output_gate),j(c_delta)的激活函数之前。
